# Comprehensive Supabase Database Seeding Script
# This will add 10+ records to each table in your Supabase database

Write-Host "🌱 Starting comprehensive Supabase database seeding..." -ForegroundColor Green
...
Write-Host "`n📂 Creating categories..." -ForegroundColor Yellow
$categories = @(
...
# 2. Create Menu Items (60+ items across all categories)
Write-Host "`n🍽️ Creating menu items..." -ForegroundColor Yellow
$menuItems = @(
...
Write-Host "`n🎉 Comprehensive database seeding completed successfully!" -ForegroundColor Green
...
Write-Host "`n🚀 Your Supabase database is now fully populated with:" -ForegroundColor Green
Write-Host "   • 12 Categories" -ForegroundColor White
Write-Host "   • 60+ Menu Items" -ForegroundColor White
Write-Host "   • Admin user ready" -ForegroundColor White
Write-Host "`n✨ You can now use your restaurant management system with real data!" -ForegroundColor Green
