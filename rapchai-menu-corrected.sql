-- Rapchai Menu Data for Supabase (Corrected Schema)
...
('cat_chais', 'Chais & Signature Coffees', 'chais-coffees', NOW(), NOW()),
('cat_burgers', 'Mini Burgers', 'mini-burgers', NOW(), NOW()),
('cat_sandwiches', 'Sandwiches', 'sandwiches', NOW(), NOW()),
('cat_rolls', 'Rolls & Soups', 'rolls-soups', NOW(), NOW()),
('cat_specials', 'Our Specials', 'our-specials', NOW(), NOW()),
('cat_squares', 'Our Squares', 'our-squares', NOW(), NOW())
