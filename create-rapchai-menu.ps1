# Clear existing data and create proper Rapchai menu
Write-Host "🍽️ Creating proper Rapchai menu for affordable vibrant cafe..." -ForegroundColor Green
...
# 1. Create proper categories for Rapchai
...
$categories = @(
    ...
    @{ name = "Our Specials"; slug = "our-specials"; description = "Chef's special creations that have become staples" },
...
# 2. Create menu items based on your specifications
...
$menuItems = @(
    ...
    # Our Specials
    @{ name = "Chef's Special Pasta"; description = "Our signature pasta creation"; pricePaise = 18000; isVeg = $true; categorySlug = "our-specials" },
    @{ name = "Special Chicken Curry"; description = "Chef's special chicken curry"; pricePaise = 20000; isVeg = $false; categorySlug = "our-specials" },
    ...
    @{ name = "Chef's Special Wrap"; description = "Our signature wrap creation"; pricePaise = 14000; isVeg = $true; categorySlug = "our-specials" },
    @{ name = "Special Fish Fry"; description = "Chef's special fish preparation"; pricePaise = 22000; isVeg = $false; categorySlug = "our-specials" },
...
foreach ($item in $menuItems) {
    try {
        Invoke-RestMethod -Uri "http://localhost:3001/api/admin/menu-items" -Method POST -Headers $headers -Body ($item | ConvertTo-Json) | Out-Null
        $successCount++
...
Write-Host "`n🚀 Your affordable vibrant cafe menu is now ready!" -ForegroundColor Green
