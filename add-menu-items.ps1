# Add Menu Items to Existing Categories in Supabase
Write-Host "🍽️ Adding menu items to existing categories..." -ForegroundColor Green
...
# Add menu items using existing categories
$menuItems = @(
...
Write-Host "`n🎉 Menu items seeding completed!" -ForegroundColor Green
Write-Host "📊 Results:" -ForegroundColor Cyan
Write-Host "   ✅ Successfully created: $successCount items" -ForegroundColor Green
Write-Host "   ❌ Failed to create: $failCount items" -ForegroundColor Red
Write-Host "`n🚀 Your Supabase database now has comprehensive menu data!" -ForegroundColor Green
