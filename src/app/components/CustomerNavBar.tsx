  ...
  if (!isHydrated) {
    return (
      ...
      <div className="w-full container-px flex h-16 items-center justify-between">
        <Link href="/home" className="text-xl md:text-2xl font-black tracking-wide text-[var(--rc-espresso-brown)] hover:text-[var(--rc-orange)] transition-colors" aria-label="RAPCHAI home">
          RAPCHAI
        </Link>
