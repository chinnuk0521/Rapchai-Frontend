...
import type { MenuItem, CartItem, CreateOrderRequest } from "../lib/types";
...
${
  customerInfo.orderType === "dine-in"
    ? `• Table Number: ${customerInfo.tableNumber}`
    : ""
}
...
*Time: ${new Date().toLocaleString("en-IN")}*`;
    ...
    const handleApiOrder = async () => {
      ...
      try {
        ...
        setOrderNumber(response.order?.orderNumber || generateOrderNumber());
        setShowOrderConfirmation(true);
                ...
                {cart.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-[var(--rc-text-secondary)]">
                      Scan the QR code and add some delicious items!
                    </p>
                  </div>
                ) : (
                  <>
                    {cart.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h3 className="font-bold text-[var(--rc-espresso-brown)]">
                            {item.name}
                          </h3>
              ...
              <div className="p-6 space-y-6">
                ...
                {orderError && (
                  <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4">
                    <p className="text-red-600 font-semibold">Order Failed</p>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-[var(--rc-orange)] to-[var(--rc-espresso-brown)] text-white font-bold text-lg hover:from-[var(--rc-espresso-brown)] hover:to-[var(--rc-orange)] transition-all disabled:opacity-50 disabled:cursor-not-allowed mb-4"
                >
                  {loading.isLoading
                    ? "Placing Order..."
                    : "Place Order via API"}
        ...
        {showOrderConfirmation && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl max-w-md w-full p-8 text-center">
              ...
              <p className="text-lg font-semibold text-[var(--rc-orange)] mb-2">
                Order #{orderNumber}
              </p>
